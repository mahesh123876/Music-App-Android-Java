...
public class Genere_Get_Songs {
    String GsongCategory,GsongTitle,Gartist,Galbum_art,GsongDuration,Gsonglink,GmKey;

    public Genere_Get_Songs() {

    }

    public Genere_Get_Songs(String gsongCategory, String gsongTitle, String gartist, String galbum_art, String gsongDuration, String gsonglink, String gmKey) {
